...
fun Route.userRoute(
    ...
    post<UserRegisterRoute>{
        ...
        try {
            val user = User(registerRequest.email,registerRequest.password,registerRequest.name)
            db.addUser(user)
            call.respond(HttpStatusCode.OK, SimpleResponse(true, jwtService.generateToken(user)))
        } catch (e: Exception){
            call.respond(HttpStatusCode.Conflict, SimpleResponse(false, e.message?: "Something is wrong"))
        }
